    ...
    <nav className="bg-[#f8f5ff] text-[#3b1c60] py-4 shadow-sm relative z-50 w-full">
      ...
      */}
      <div className="w-full px-6 md:px-12 flex justify-between items-center">
        ...
        {/* BOTÓN DE TRES PUNTOS (SOLO CELULAR) */}
        <button
          onClick={toggleMenu}
          className="lg:hidden p-2 rounded-lg hover:bg-purple-100 transition-colors focus:outline-none"
          aria-label="Menú de opciones"
        >
          <svg className="w-7 h-7 fill-current text-[#3b1c60]" viewBox="0 0 24 24">
            <path d="M12 8c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0 2c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm0 6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"/>
          </svg>
        </button>
      </div>

      {/* MENÚ DESPLEGABLE DE 3 PUNTOS (CELULAR) */}
      {menuAbierto && (
