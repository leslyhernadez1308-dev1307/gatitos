    ...
    <>
      ...
      <div className="w-full mt-[-80px] relative z-0">
        <svg viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg" className="ola-animada">
          <path fill="#eaddf6" fillOpacity="1" d="M0,160L80,144C160,128,320,96,480,106.7C640,117,800,171,960,176C1120,181,1280,139,1360,117.3L1440,96L1440,320L1360,320C1280,320,1120,320,960,320C320,320,160,320,80,320L0,320Z"></path>
        </svg>
      </div>
    </>
  );
